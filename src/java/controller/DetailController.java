...
public class DetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            // Khởi tạo giá trị cố định cho productId nếu chưa được thiết lập từ request
int productId = 32;

// Kiểm tra xem request có chứa thông tin productId không
if (request.getParameter("productId") != null && !request.getParameter("productId").isEmpty()) {
    // Nếu có, thì cập nhật giá trị productId từ request
    productId = Integer.parseInt(request.getParameter("productId"));
}

// Tiếp tục với các bước khác trong mã của bạn
